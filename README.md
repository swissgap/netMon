...
1. **network_scanner.py** - Automatischer Netzwerk-Scanner
...
### Standalone:
1. Scanner ausführen: `python3 network_scanner.py`
...
In `network_scanner.py`, Zeile 125:
```python
...
Editiere die `device_signatures` in `network_scanner.py` (Zeile 17-52).
